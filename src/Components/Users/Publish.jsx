...
const Subscribe = ({ brokerOptions }) => {
  ...
  useEffect(() => {
    ...
    const newSocket = io("http://13.202.129.139:5000", {
  ...
  useEffect(() => {
    const fetchMessages = async () => {
      try {
        ...
        const response = await fetch("http://13.202.129.139:5000/api/messages", {
          headers: {
  ...
  const handleSubscribe = async (e) => {
    ...
    try {
      ...
      const response = await fetch("http://13.202.129.139:5000/api/subscribe", {
        method: "POST",
        headers: {
  ...
  const handleUnsubscribe = async (e) => {
    ...
    try {
      ...
      const response = await fetch("http://13.202.129.139:5000/api/unsubscribe", {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${authToken}`,
  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      for (let index = 0; index < inputSets.length; index++) {
        ...
        const response = await fetch("http://13.202.129.139:5000/api/pub/publish", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${authToken}`,
