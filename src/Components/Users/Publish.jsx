...
const Subscribe = ({ brokerOptions }) => {
  ...
  useEffect(() => {
    ...
    const newSocket = io("http://13.201.135.43:5000", {
  ...
  useEffect(() => {
    const fetchMessages = async () => {
      try {
        ...
        const response = await fetch("http://13.201.135.43:5000/api/messages", {
          headers: {
  ...
  const handleSubscribe = async (e) => {
    ...
    try {
      ...
      const response = await fetch("http://13.201.135.43:5000/api/subscribe", {
        method: "POST",
        headers: {
  ...
  const handleUnsubscribe = async (e) => {
    ...
    try {
      ...
      const response = await fetch("http://13.201.135.43:5000/api/unsubscribe", {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${authToken}`,
                ...
                <div className="subscribe-inputs-container p-3">
                  {subscribeInputSets.map((inputSet, index) => (
                    <div key={index} className="subscribe-input-set mb-3">
                      ...
                      <div className="messages-wrapper" style={{ padding: "1px", marginTop: "10px"}}>
  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      for (let index = 0; index < inputSets.length; index++) {
        ...
        const response = await fetch("http://13.201.135.43:5000/api/pub/publish", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${authToken}`,
